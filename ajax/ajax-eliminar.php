...
class DeleteControllerr{
	...
	public function dataDelete(){
		...
		if($security[1] == $this->token){
			...
			if($this->table == "categoriatramites"){

				$url = "tramites?select=id_categoriatramite_tramite&linkTo=id_".$this->suffix."_tramite&equalTo=".$security[0];
				$method = "GET";
				$fields = array();
...
if(isset($_POST["idItem"])){
	...
	$validate = new DeleteControllerr();
