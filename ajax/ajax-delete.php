...
class DeleteController{
	...
	public function dataDelete(){
		...
		if($security[1] == $this->token){
			...
			if($this->table == "categorianegocios" || $this->table == "barrios"){

				$url = "negocios?select=id_negocio&linkTo=id_".$this->suffix."_negocio&equalTo=".$security[0];
				$method = "GET";
				$fields = array();
