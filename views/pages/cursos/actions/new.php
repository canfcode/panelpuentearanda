		...
		<div class="card-header">
			...
			<div class="col-md-8 offset-md-2">	
				...
				<div class="form-group mt-2">
					...
					<label for="customFileCover" class="d-flex justify-content-center">
						...
						<figure class="text-center py-3">
							...
							<img src="<?php echo TemplateController::srcImg() ?>views/img/cursos/default/default-cover.jpg" class="img-fluid changeCover">
		        ...
		        <div class="form-group mt-2">
		            ...
		            <label>Contenido Curso<sup class="text-danger">*</sup></label>
                ...
                <div class="form-group mt-2">
					...
					<label>Descripcion Curso<sup class="text-danger">*</sup></label>
					<input 
					type="text" 
					class="form-control"
		...
		<div class="card-footer">
			...
			<div class="col-md-8 offset-md-2">
				...
				<div class="form-group mt-3">
					...
					<a href="/cursos" class="btn btn-light border text-left">Atras</a>
