...
<div class="card">
  <div class="card-header">
    ...
    <h3 class="card-title"> 
      <a class="btn bg-dark btn-sm" href="catnegocios/new">Nueva Categoria de Negocios</a>
    </h3>
  ...
  <!-- /.card-header -->
  <div class="card-body">
    <table id="adminsTable" class="table table-bordered table-striped tableCatNegocios">
      <thead>
      <tr>
        <th>#</th>
        <th>Nombre</th>
