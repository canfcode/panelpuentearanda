<?php 
	...
	if(isset($routesArray[3])){
		...
		if($security[1] == $_SESSION["admin"]->token_user){
			...
			$url = "relations?rel=tramites,categoriatramites&type=tramite,categoriatramite&select=".$select."&linkTo=id_tramite&equalTo=".$security[0];
			$method = "GET";
			$fields = array();
...
<div class="card card-dark card-outline">
	...
	<form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
		...
		<input type="hidden" value="<?php echo $datacurso->id_tramite ?>" name="idTramite">
		...
		<div class="card-header">
			...
			<?php
				...
				$create -> edit($datacurso->id_tramite);
			...
			<div class="col-md-8 offset-md-2">	
                ...
                <div class="form-group mt-2">
					...
					maxlength="50"
					name="nombre-noticia"
					value="<?php echo $datacurso->nombre_tramite?>"
					required>
		        ...
		        <div class="form-group mt-2">
		            ...
		            <div class="form-group">
		                ...
		                required>
		                    ...
		                    <option value=""><?php echo $datacurso->nombre_categoriatramite ?></option>
				...
				<div class="form-group mt-2">
					...
					<label for="customFileCover" class="d-flex justify-content-center">
						...
						<figure class="text-center py-3">
							...
							<?php $rutaimg=TemplateController::rutasimg($datacurso->nombre_tramite);?>

							<img src="<?php echo TemplateController::srcImg() ?>views/img/tramites/<?php echo $rutaimg ?>/<?php echo $datacurso->imagen_tramite ?>" class="img-fluid changeCover">
		        ...
		        <div class="form-group mt-2">
		            ...
		            <label>Contenido del Tramite<sup class="text-danger">*</sup></label>

		            <textarea
		            class="summernote"
		            name="cuerpo-noticia"
		            required
		            ><?php echo $datacurso->contenido_tramite?></textarea>
		        ...
		        <!--=====================================
                resumern de 160 caracteres                
                ======================================-->

                <div class="form-group mt-2">
					
					<label>Descripcion del tramite<sup class="text-danger">*</sup></label>
					<input 
					type="text" 
					class="form-control"
					...
					value="<?php echo $datacurso->descripcion_tramite?>"
					required>
