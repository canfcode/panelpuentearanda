...
<head>
  ...
  <?php if (!empty($routesArray[1]) && !isset($routesArray[2])): ?>
    ...
    <?php if ($routesArray[1] == "admins" || 
              $routesArray[1] == "barrios" ||
              $routesArray[1] == "users" ||
              $routesArray[1] == "catnegocios" ||
              $routesArray[1] == "catnoticias" ||
              $routesArray[1] == "catcursos" ||
              $routesArray[1] == "noticias" ||
              $routesArray[1] == "cursos" ||
              $routesArray[1] == "mensajes" ||
              $routesArray[1] == "cattramites" ||
              $routesArray[1] == "tramites" ||
              $routesArray[1] == "catdenuncias" ||
              $routesArray[1] == "denuncias" ||
              $routesArray[1] == "gpqrs" ||
              $routesArray[1] == "negocios"
             ): 
    ?>
